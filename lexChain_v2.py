...
class LexicalChain:
    ...
    def findBestSentences(self,sentences,maxSent,sentenceScore):
        global summary
        summary=[]
    ...
    def assignChain(self,wordList,chains,sentences,percentage):
        global lineNumber
        global addedToChain
        lineNumber=-1
        addedToChain=0
        ...
        self.findBestSentences(sentences,maxSent,sentenceScore)
